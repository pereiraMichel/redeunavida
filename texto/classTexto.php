...
//        echo "                  <b>Texto do Evangelho desta semana - 28/08/2016</b><br>";
        echo "                  <b>Texto do Evangelho desta semana - domingo - 17.09.2017<br>";
        echo "                  MC Temporalidade</b><br>";
        echo "              <br><br>";
        echo "                  <a role='button' href='downloads/meditacaocrista/MC157ParagemTemporalidadeConvite.pdf' aria=expanded='false' target='_blank' style='".$margem.";'>Clique aqui</a> a partir da 5ª feira anterior para ler o convite da MC do próximo domingo (17.09.2017).";
        echo "              <br><br>";
        echo "                  <a role='button' target='_blank' href='downloads/meditacaocrista/MC157ParagemTemporalidade.pdf' aria=expanded='false' aria-controls='' style='".$margem.";'>Clique aqui</a> a partir da 3ª feira posterior para ler a MC do domingo passado (17.09.2017).";
        echo "              <br><br>";
...
//        echo "                          <a href='/downloads/meditacaocrista/MC108Paragem114.pdf' id='linkDownloads'>108<p style='font-size: 13px;'>09.10.2016</p></a>";//style='background-color: #FFA07A;'
        ...
        echo "                      </td>";
        echo "                      <td id='tdHover'>";
        echo "                           <a href='meditcrista.php?s=155' id='linkDownloads'>155<p style='font-size: 13px;'>03.09.2017</p></a>";
        echo "                      </td>";
        echo "                      <td id='tdHover'>";
        echo "                           <a href='meditcrista.php?s=156' id='linkDownloads'>156<p style='font-size: 13px;'>10.09.2017</p></a>";
        echo "                      </td>";
        echo "                      <td id='tdHover'>";
        echo "                           <a href='meditcrista.php?s=157' id='linkDownloads'>157<p style='font-size: 13px;'>17.09.2017</p></a>";
        echo "                      </td>";
        echo "                      <td>";
