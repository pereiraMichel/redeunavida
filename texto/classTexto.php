...
//        echo "                  <b>Texto do Evangelho desta semana - 28/08/2016</b><br>";
        echo "                  <b>Texto do Evangelho desta semana - domingo - 05.02.2017<br>";
        echo "                  MC 224</b><br>";
        echo "              <br><br>";
        echo "                  <a role='button' href='downloads/meditacaocrista/MC126Paragem231Convite.pdf' aria=expanded='false' target='_blank' style='".$margem.";'>Clique aqui</a> a partir da 5ª feira anterior para ler o convite da MC do próximo domingo (12.02.2017).";
        echo "              <br><br>";
        echo "                  <a role='button' target='_blank' href='downloads/meditacaocrista/MC125Paragem224.pdf' aria=expanded='false' aria-controls='' style='".$margem.";'>Clique aqui</a> a partir da 3ª feira posterior para ler a MC do domingo passado (05.02.2017).";
        echo "              <br><br>";
