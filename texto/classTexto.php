...
//        echo "                  <b>Texto do Evangelho desta semana - 28/08/2016</b><br>";
        echo "                  <b>Texto do Evangelho desta semana - domingo - 08.01.2017<br>";
        echo "                  MC 214</b><br>";
        echo "              <br><br>";
        echo "                  <a role='button' href='downloads/meditacaocrista/MC121Paragem214Convite.pdf' aria=expanded='false' target='_blank' style='".$margem.";'>Clique aqui</a> a partir da 5ª feira anterior para ler o convite da MC do próximo domingo (08.01.2017).";
        echo "              <br><br>";
        echo "                  <a role='button' target='_blank' href='downloads/meditacaocrista/MC121Paragem214.pdf' aria=expanded='false' aria-controls='' style='".$margem.";'>Clique aqui</a> a partir da 3ª feira posterior para ler a MC do domingo passado (08.01.2017).";
        echo "              <br><br>";
...
//        echo "                          <a href='/downloads/meditacaocrista/MC108Paragem114.pdf' id='linkDownloads'>108<p style='font-size: 13px;'>09.10.2016</p></a>";//style='background-color: #FFA07A;'
        ...
        echo "                      </td>";
        echo "                      <td>";
        echo "                           <a href='meditcrista.php?s=120' id='linkDownloads'>120<p style='font-size: 13px;'>01.01.2016</p></a>";
        echo "                      </td>";
        echo "                  </tr>";
        echo "                  <tr style='text-align: center; background-color: #FFEFD5; height: 60px;'>";
        echo "                      <td>";
        echo "                           <a href='meditcrista.php?s=121' id='linkDownloads'>121<p style='font-size: 13px;'>08.01.2016</p></a>";
        echo "                      </td>";
        echo "                      <td>";
        echo "                           122";
        echo "                      </td>";
