	...
	<header id="header">
        ...
        <div id="content">
            <div class="bs-docs-header bs-docs-first">
                <div class="container">
                    <h3 class="text-info"><i class="fa fa-puzzle-piece"></i> PROGRAMAÇÃO</h3>
                    <small>
                        <?php
                        $filename = "texto/programacao.xml";
...
//                        $filename = "texto/programacao.txt";
//                        $mode = "r";
//                        
...
<!--				<a class="navbar-brand" href="index.php">
			...
			<div class="collapse navbar-collapse" id="example-navbar-collapse">
				<ul class="nav navbar-nav navbar-right" id="menu">
					...
					<li class="active" id="programacao">
						<a href="#">
