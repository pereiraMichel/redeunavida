        ...
        <div id="content">
            <div class="bs-docs-header bs-docs-first">
                <div class="container">
                    ...
                    <h3 class="text-info"><i class="fa fa-download"></i> DOWNLOADS - INVERNO</h3>
                    <br/>
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="col-md-8 text-center">
                                <table class="table small">
                                    ...
                                    <tr>
                                        <td colspan="3" class="info">17/10/2015</td>
                                    </tr>
                                    <tr class="warning">
                                        <td>
                                                Jornada Real - Livro de Programa inverno 2015
                                            </a>
                                        </td>
                                        <td>
                                            <a href="downloads/inverno/10 Jornada Real - Livro de Programa inverno 2015.pdf" target="_blank">
                                                <img src="images/icon-pdf.png" title="Arquivo em formato PDF">
                                            </a>
                                            
                                        </td>
                                        <td>
                                            <a href="downloads/inverno/10 Jornada Real - Livro de Programa inverno 2015.doc">
