...
//        echo "      <div class='navbar-header'>";
        ...
        echo "      <li>";
//	echo "          <a href='#' class='text-link'>";
//        echo "              <button class='btn btn-warning btn-sm btn-responsive' disabled>";
...
//        echo "          <a href='#enviarAdesao' role='button' data-toggle='modal' style='text-decoration: none;' class='text-link'>";
    ...
    public function telaLogin(){
       ...
       echo "   <form class='form-signin' name='formlogin' action='index.php' enctype='multipart/form-data' method='post'>";
