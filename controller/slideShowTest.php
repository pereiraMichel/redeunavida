...
//TELAS
    ...
    public function telaLogoMarcasTest(){
...
//        echo "</li>";
    ...
    public function telaLogoMarcasHorizontalTest(){
    ...
    public function telaTituloTest(){
...
//        echo "      <div class='navbar-header'>";
        ...
        echo "              <span class='icon-bar'></span>";
        echo "          </button>";
        echo "          <div class='navbar-subtext-top' style='padding-top: 20px; padding-left: 15px;'>";
...
//        echo "</div>";        
    ...
    public function telaNovaSlideTest(){
        echo "<div class='featured'>";
        echo "<ul class='bxslider' style='width: 100%;' data-options='slideMargin:10, slides:4' data-breaks='[{screen:460, slides:2, pager:false},{screen:768, slides:3, pager:true}]>";
        echo "  <li>";
