...
//					</li>
    ...
    public function avisoMais(){
        echo "<div style='text-align: justify; font-family: garamond; font-size: 20px; color: #1f226d;'>";
        ...
        echo "<span style='color: red; font-weight: bold;'>Iyengar Yoga</span> com os professores Eduardo Quintela e Heiko Hoschke.<br/><br/>";
