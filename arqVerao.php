...
<html lang="pt-br">
    <head>
        ...
        <style>
            ...
            {
                padding-top: 80px;
                background-color: <?php echo BODYLARANJA; ?>
            }
    ...
    <body>
        <header id="header">
            <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="corAmarelo">
        ...
        <div id="content">
            <div class="bs-docs-header bs-docs-first">
                <div class="container">
                    ...
                    <h3 class="text-info"><i class="fa fa-download"></i> DOWNLOADS - VERÃO</h3>
                    <br/>
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="col-md-8 text-center">
                                <table class="table small">
                                    ...
                                    <tr>
                                        <td colspan="3" style="background-color: #FFA500;">17/10/2015</td>
                                    </tr>
                                    <tr class="warning">
                                        <td>
                                                Jornada Real - Livro de Programa verao 233 o mentum
                                            </a>
                                        </td>
                                        <td>
                                            <a href="downloads/verao/05 Jornada Real - Livro de Programa verao 233 o mentum.pdf" target="_blank">
                                                <img src="images/icon-pdf.png" title="Arquivo em formato PDF">
                                            </a>
                                            
                                        </td>
                                        <td>
                                            <a href="downloads/verao/05 Jornada Real - Livro de Programa verao 233 o mentum.doc">
                                    ...
                                    <tr class="warning">
                                        <td>
                                                Jornada Real - Livro de Programa verao 234 reformatando
                                        </td>
                                        <td>
                                            <a href="downloads/verao/06 Jornada Real - Livro de Programa verao 234 reformatando.pdf" target="_blank">
                                                <img src="images/icon-pdf.png" title="Arquivo em formato PDF">
                                            </a>
                                            
                                        </td>
                                        <td>
                                            <a href="downloads/verao/06 Jornada Real - Livro de Programa verao 234 reformatando.doc">
                                                <img src="images/word_icon.png" title="Arquivo em formato Word 2007">
                                            </a>
                                        </td>
                                    ...
                                    <tr class="warning">
                                        <td>
                                                Jornada Real - Livro de Programa verao 4
                                        </td>
                                        <td>
                                            <a href="downloads/verao/07 Jornada Real - Livro de Programa verao 4.pdf" target="_blank">
                                                <img src="images/icon-pdf.png" title="Arquivo em formato PDF">
                                            </a>
                                            
                                        </td>
                                        <td>
                                            <a href="downloads/verao/07 Jornada Real - Livro de Programa verao 4.docx">
                                                <img src="images/word_icon.png" title="Arquivo em formato Word 2007">
                                            </a>
                                        </td>
        ...
        <footer id="footer">
            ...
            <nav class="navbar navbar-default navbar-fixed-bottom" role="navigation" id="corAmarelo">
                <?php
